        ...
        <div className="content-page">
            ...
            <div className="content-text">
                <div className="acid-table">
                    <div className="acid-header">
                        <div className="acid-header-cell">SQL Command</div>
                        <div className="acid-header-cell">Description</div>
                        <div className="acid-header-cell">Real-World Analogy</div>
                    </div>
                    
                    <div className="acid-row">
                        <div className="acid-cell acid-command-name">Atomicity</div>
                        <div className="acid-cell">Ensures all parts of a transaction are completed, or none are.</div>
                        <div className="acid-cell">A light switch# It's either entirely on or fully off—no in-between state.</div>
                    </div>
                    
                    <div className="acid-row">
                        <div className="acid-cell acid-command-name">Consistency</div>
                        <div className="acid-cell">Guarantees that a transaction leaves the database in a valid state and adheres to rules and constraints.</div>
                        <div className="acid-cell">A scale# If weight is added to one side, the other side adjusts to maintain balance.</div>
                    </div>
                    
                    <div className="acid-row">
                        <div className="acid-cell acid-command-name">Isolation</div>
                        <div className="acid-cell">Prevents transactions from interfering with each other, ensuring data is processed as if each transaction runs alone.</div>
                        <div className="acid-cell">Grocery checkout# Everyone in line is served individually without mixing up their items.</div>
                    </div>
                    
                    <div className="acid-row">
                        <div className="acid-cell acid-command-name">Durability</div>
                        <div className="acid-cell">Ensures that once a transaction is committed, its changes are permanent, even in a system failure.</div>
                        <div className="acid-cell">Saving a document# It remains intact even if your computer crashes.</div>
                    </div>
                </div>
