...
import '../../App.css';
import feature1 from '../../assests/feature 1.png';
import feature2 from '../../assests/feature 2.png';
import featureleft from '../../assests/feature left img.png';
import featureright from '../../assests/practice sql img.png';
...
const Feature = () => {
    return (
        <div className="feature-section">
            ...
            {/* Feature Right Image - Bottom Right Corner */}
            <img src={featureright} alt="Feature Right" className="feature-right-image" />
            ...
            <div className="feature-content">
                {/* Feature 1 Image - 6 Feature Cards */}
                <div className="feature-image-container">
                    <img src={feature1} alt="Features Overview" className="feature-image" />
                </div>

                {/* Feature 2 Image - Perfect For Section */}
                <div className="feature-image-container">
